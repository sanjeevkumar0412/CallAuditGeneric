...
# place keys here
    ...
    def transcribe_open_ai(self,output_file,dir_url,name):
    ...
    def transcribe_by_open_ai_old(self,chunks_files,chunk_directory,chunks,filename):   
            try: 
    ...
    def transcribe_by_open_ai(self,chunks_files,chunk_directory,chunks,filename):   
            try: 
                txt_file = chunk_directory+'/'+filename+'.txt'
                for i in range(len(chunks_files)):   
                        chunk_file = f"{chunk_directory}/chunk_{i}.wav"
    ...
    def transcribe_by_whisper(self,chunks_files,chunk_directory,chunks,filename):       
            model = whisper.load_model("tiny")
            try: 
                txt_file = chunk_directory+'/'+filename+'.txt'
                for i in range(len(chunks_files)):   
